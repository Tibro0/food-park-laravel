                                ...
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @foreach ($order->orderItems as $orderItem)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b>Size:</b>
                                                {{ @$size->name }} ({{ currencyPosition(@$size->price) }})<br>
                                                <b>Options:</b>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="images">
                                        @if ($order->payment_method === 'paypal')
                                            <img src="{{ asset(config('gatewaySettings.paypal_logo')) }}" alt="paypal">
                                        @elseif ($order->payment_method === 'Stripe')
                                            <img src="{{ asset(config('gatewaySettings.stripe_logo')) }}" alt="paypal">
                                        @elseif ($order->payment_method === 'Razorpay')
                                            <img src="{{ asset(config('gatewaySettings.razorpay_logo')) }}" alt="paypal">
                                        @endif
                                    </div>
                                    <!-- Change Order Status Form Start -->
