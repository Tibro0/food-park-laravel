        ...
        <div class="card-body border">
            <form action="{{ route('admin.paypal-setting.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="paypal_status" class="select2 form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="paypal_account_mode" class="select2 form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="paypal_country" class="select2 form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="paypal_currency" class="select2 form-control">
                        <option value="">Select</option>
