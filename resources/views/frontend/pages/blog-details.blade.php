...
@push('frontend-css')
    <title>FoodPark || Blog Details</title>
@endpush
                ...
                <div class="col-xl-8 col-lg-8">
                        ...
                        @if ($previousBlog)
                            <li>
                                <a href="{{ route('blogs.details', $previousBlog->slug) }}">
                                    <p>{{ limitText($previousBlog->title, 40) }}
                    ...
                    <div class="fp__comment mt_100 xs_mt_70 wow fadeInUp" data-wow-duration="1s">
                        ...
                        <div class="fp__single_comment m-0 border-0">
                            <img src="{{ asset('frontend/images/comment_img_1.png') }}" alt="review" class="img-fluid">
                        ...
                        <div class="fp__single_comment replay">
                            <img src="{{ asset('frontend/images/comment_img_2.png') }}" alt="review" class="img-fluid">
                            <div class="fp__single_comm_text">
                            ...
                            <ul>
                                @foreach ($latestBlogs as $latestBlog)
                                    <li>
                                        ...
                                        <div class="text">
                                            <a
                                                href="{{ route('blogs.details', $latestBlog->slug) }}">{{ limitText($latestBlog->title, 50) }}</a>
