    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='".route('admin.product.destroy', $query->id)."' class='btn btn-danger ml-2 mr-2' id='delete'><i class='fas fa-trash'></i></a>";
            ...
            ->rawColumns(['action', 'price', 'offer_price', 'status', 'show_at_home', 'image', 'category'])
            ->setRowId('id');
    }
