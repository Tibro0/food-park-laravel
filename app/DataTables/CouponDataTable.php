    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='".route('admin.coupon.destroy', $query->id)."' class='btn btn-danger ml-2' id='delete'><i class='fas fa-trash'></i></a>";
            ...
            ->addColumn('discount_type', function($query){
                if($query->discount_type === 'percent'){
                    ...
                    return '<span class="badge badge-warning">Amount</span>';
                }
            })
            ...
            ->rawColumns(['action', 'discount_type', 'status'])
            ->setRowId('id');
    }
