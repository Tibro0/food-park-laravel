    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='".route('admin.blogs.comments.destroy', $query->id)."' class='btn btn-danger ml-2' id='delete'><i class='fas fa-trash'></i></a>";
            ...
            ->addColumn('date', function($query){
                return date('d-m-Y | g:i a', strtotime($query->created_at));
            })
